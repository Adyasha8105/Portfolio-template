         ...
         <div className="nine columns main-col">
            ...
            <div className="row">
               <div className="columns download">
                  <p>
                     <a href="https://drive.google.com/uc?export=pdf&id=1JZ_9_koC-W0jVg39lGh8Jd0hwJzv8kqn" className="button" target="_blank"><i className="fa fa-download"></i>Download Resume</a>
                  </p>
               </div>
            </div>
         </div>
